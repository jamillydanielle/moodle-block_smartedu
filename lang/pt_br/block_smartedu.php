...
$string['prompt:simplesummary'] = 'Com base no conteúdo da aula a seguir, escreva um resumo simples de no máximo 10 frases, destacando os principais conceitos abordados de forma objetiva e clara para um aluno de graduação. Conteúdo da aula: {$a}';
$string['prompt:detailedsummary'] = 'Com base no conteúdo da aula a seguir, escreva um resumo detalhado de no máximo 30 frases, destacando e explicando os principais conceitos abordados para um aluno de graduação. Conteúdo da aula: {$a}';
...
$string['prompt:simpleforum'] = 'Você vai receber uma série de discussões de um fórum, no formato JSON. Sua tarefa é escrever um resumo simples de no máximo 10 frases sobre o conteúdo de cada discussão e retornar um array no formato JSON, conforme o seguinte exemplo: [{"name": "Título da discussão do fórum", "content": "Mensagens do fórum relacionadas à discussão"}]. Mensagens do fórum: {$a}';
$string['prompt:detailedforum'] = 'Você vai receber uma série de discussões de um fórum, no formato JSON. Sua tarefa é escrever um resumo detalhado de no máximo 30 frases sobre o conteúdo de cada discussão, destacando os principais pontos discutidos e as conclusões alcançadas, e retornar um array no formato JSON, conforme o seguinte exemplo: [{"name": "Título da discussão do fórum", "content": "Mensagens do fórum relacionadas à discussão"}]. Mensagens do fórum: {$a}';
