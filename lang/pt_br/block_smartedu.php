...
$string['generatestudyguide'] = "Gerar roteiro de estudo";
$string['generatemindmap'] = "Gerar mapa mental";
...
$string['prompt:studyscript'] = 'Escreva também um roteiro de estudo para esta aula, formatado em HTML utilizando tags h5 para títulos, contendo o tema principal, os objetivos do texto, quais os assuntos que precisam ser aprendidos e o que o estudante deve ser capaz de saber após a leitura do texto. Retorne o guia de estudo no seguinte formato: "study_script": "Roteiro de estudo da aula". ';
$string['prompt:mindmap'] = 'Crie também um mapa mental dos principais conceitos da aula, em um formato que possa ser lido corretamente pela biblioteca JavaScript MindElixir, conforme o exemplo a seguir: {"nodeData": {"id": "root", "topic": "root", "children": [{"id": "sub1", "topic": "sub1", "children": [{"id": "sub2", "topic": "sub2"}]}]}}. Retorne o mapa mental no seguinte formato: "mind_map": "Conteúdo do mapa mental". ';
$string['prompt:quizz'] = 'Elabore {$a} questões de múltipla escolha, com 4 alternativas (A, B, C, D), sendo apenas uma correta. Para cada alternativa, forneça uma breve explicação do porquê ela é correta ou incorreta, sem mencionar a palavra Correta ou Incorreta antes da explicação. Retorne as questões elaboradas em formato JSON, conforme exemplo a seguir: "questions": [{"question": "Texto da pergunta", "options": {"A": "Texto da alternativa A", "B": "Texto da alternativa B", "C": "Texto da alternativa C", "D": "Texto da alternativa D"}, "feedbacks": {"A": "Explicação da alternativa A", "B": "Explicação da alternativa B", "C": "Explicação da alternativa C", "D": "Explicação da alternativa D"}, "correct_option": "Letra da alternativa correta"}]. ';
