...
$string['prompt:mindmap'] = 'Also, create a mind map covering the main concepts of the lesson, in a format suitable to be read by the MindElixir JavaScript library. ';
