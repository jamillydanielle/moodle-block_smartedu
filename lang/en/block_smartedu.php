...
$string['prompt:returnwithquestions'] = 'Return the summary, the study guide, and the questions in a JSON file with the following structure: {"summary": "Lecture summary", "study_script": "Lecture study guide", "questions": [{"question": "Question text", "options": {"A": "Option A text", "B": "Option B text", "C": "Option C text", "D": "Option D text", },"correct_option": "Letter of the correct option"}]}. Lecture content: {$a}';
$string['prompt:returnwithoutquestions'] = 'Return the summary and the study guide in a JSON file with the following structure: {"summary": "Lecture summary", "study_script": "Lecture study guide"}. Lecture content: {$a}';
$string['privacy:metadata'] = 'The SmartEdu block only displays existing course data.';
$string['prompt:forum'] = 'You will receive a series of forum discussions in JSON format. Your task is to summarize the content of the discussions and return a JSON in the same format, highlighting the main points discussed and the conclusions reached. The summary should be clear and concise, with a maximum of 300 words. Forum messages: {$a}';
