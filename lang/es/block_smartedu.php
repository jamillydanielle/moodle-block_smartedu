...
$string['prompt:simplesummary'] = 'Con base en el siguiente contenido de la clase titulada "{$a}", redacta un resumen simple de no más de 10 oraciones, destacando los conceptos principales de forma clara y objetiva para un estudiante de pregrado. Devuelve el resumen en el siguiente formato: "summary": "Resumen de la clase". ';
$string['prompt:detailedsummary'] = 'Con base en el siguiente contenido de la clase titulada "{$a}", redacta un resumen detallado de no más de 20 oraciones, destacando y explicando los conceptos principales para un estudiante de pregrado. Devuelve el resumen en el siguiente formato: "summary": "Resumen de la clase". ';
